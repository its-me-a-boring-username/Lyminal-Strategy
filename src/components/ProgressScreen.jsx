...
Do NOT introduce yourself. Just ask your question directly.`,
  ...
  return (
    <div style={{ background: "white", borderLeft: `3px solid ${goalColor}` }}>
      {/* B-style card header */}
      <div style={{ padding: "14px 18px", display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: "10px", background: isDefault ? paleSphereColor(activeGoal?.sphereColor) : "rgba(var(--ly-accent-rgb), 0.08)", borderBottom: `1px solid ${isDefault ? paleSphereColorBorder(activeGoal?.sphereColor) : "rgba(var(--ly-accent-rgb), 0.15)"}` }}>
  ...
  if (spheres.length === 0) {
    return (
      <div className="min-h-screen lg:flex" style={{ background: "#1c1c21", fontFamily: "'Inter', sans-serif" }}>
        <style>{FONTS}</style>
        <div className="hidden lg:block flex-shrink-0" style={{ width: "350px", background: "#a05c28" }} />
          ...
          <div className="px-6 py-10 max-w-4xl mx-auto w-full lg:px-16">
            <div style={{ border: "1px solid #e8e0d5", background: "white", padding: "40px 24px", textAlign: "center", borderRadius: "8px" }}>
              ...
              <button
                ...
                style={{ background: "#a05c28", color: "#f0ebe2", fontSize: "0.75rem", fontWeight: 600, letterSpacing: "0.06em", padding: "10px 24px", border: "none", cursor: "pointer", borderRadius: "6px" }}
              >
                GO TO MY GOALS →
              </button>
            </div>
      ...
      <div className="w-full lg:flex-1 lg:flex lg:flex-col">
        ...
        <div className="w-full pb-24 lg:pb-12">
          ...
          <div className="lg:px-16" style={{
            ...
            <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "1.75rem", fontWeight: 600, color: "#f0ebe2", margin: "0 0 4px" }}>
              How far you've come
            </h2>
