  ...
  return (
    <div className="min-h-screen lg:flex" style={{ background: "var(--ly-bg)", fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="w-full lg:flex-1 lg:flex lg:flex-col">
        ...
        {/* Page header with sphere tint (desktop) or copper (mobile) */}
        <div style={{ background: isMobile ? "#a05c28" : (isDefault ? hexToRgba(priorityColor, 0.07) : "rgba(var(--ly-accent-rgb), 0.07)"), borderBottom: isMobile ? "1px solid rgba(255,255,255,0.1)" : (isDefault ? `1px solid ${hexToRgba(priorityColor, 0.12)}` : "1px solid rgba(var(--ly-accent-rgb), 0.12)"), padding: "28px 24px 24px", marginBottom: "0" }}
          className="lg:px-16">
          {isMobile && <Nav step="active" setStep={setStep} isMobile={isMobile} isPaid={isPaid} activeGoals={activeGoals} session={session} />}
        ...
        <div className="px-6 py-8 max-w-4xl mx-auto w-full lg:px-16 pb-24 lg:pb-12">
          ...
          <div className="flex gap-3 flex-col">
            <button
              ...
              style={{
                borderRadius: "6px",
                background: isPaid ? "#4a7c8e" : "rgba(255,255,255,0.06)",
                color: isPaid ? "white" : "#888690",
                border: isPaid ? "none" : "1px dashed #3a3a40",
            ...
            <button
              ...
              style={{ color: "#888690", border: "1px solid #3a3a40", borderRadius: "6px" }}
            >
              View your chart
            </button>
          </div>
